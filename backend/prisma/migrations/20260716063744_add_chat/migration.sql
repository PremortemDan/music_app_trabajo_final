...
-- CreateIndex
CREATE INDEX "conversations_user1_id_updated_at_idx" ON "conversations"("user1_id", "updated_at");

-- CreateIndex
CREATE INDEX "conversations_user2_id_updated_at_idx" ON "conversations"("user2_id", "updated_at");
